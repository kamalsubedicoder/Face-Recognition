...
def load_images_from_folder(folder):
    ...
    for path,subdirnames,filenames in os.walk(folder):
        ...
        for filename in filenames:
            ...
            cv2.imwrite(r"C:\Users\Kieron subedi\Image\Filtered test images\filtered_test" + str(n) + ".jpg",img_median)
            cv2.waitKey(0)
            cv2.destroyAllWindows()

    return images

folder=r"C:\Users\Kieron subedi\Image\Test images"
load_images_from_folder(folder)
print(" Filtered all test images. ")
