...
def faceDetection(test_img):             
    ...
    #gray_img=test_img
    face_haar=cv2.CascadeClassifier(r'C:\Users\Kieron subedi\Image\haarcascade_frontalface_alt.xml') #Give path to haar classifier as i have given
...
def put_text(test_img,text,x,y):                                    
    cv2.putText(test_img,text,(x,y),cv2.FONT_HERSHEY_DUPLEX,3,(255,0,0),5)
